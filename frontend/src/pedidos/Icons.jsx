// Pedidos — small icon wrappers from Lucide-style paths. Stroke 1.75, currentColor.
...
const IconBox = (p) => <Icon {...p}><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16Z"/><path d="m3.3 7 8.7 5 8.7-5"/><path d="M12 22V12"/></Icon>;
const IconMap = (p) => <Icon {...p}><path d="m3 6 6-3 6 3 6-3v15l-6 3-6-3-6 3z"/><path d="M9 3v15"/><path d="M15 6v15"/></Icon>;
const IconGauge = (p) => <Icon {...p}><path d="m12 14 4-4"/><path d="M3.34 19a10 10 0 1 1 17.32 0"/></Icon>;
...
const IconRefresh = (p) => <Icon {...p}><path d="M21 12a9 9 0 0 1-9 9 9.75 9.75 0 0 1-6.74-2.74L3 16"/><path d="M3 12a9 9 0 0 1 9-9 9.75 9.75 0 0 1 6.74 2.74L21 8"/><path d="M21 3v5h-5"/><path d="M3 21v-5h5"/></Icon>;
...
const IconClose = (p) => <Icon {...p}><path d="M18 6 6 18M6 6l18 12" transform="translate(-3 0)"/></Icon>;

Object.assign(window, { Icon, IconInbox, IconBox, IconMap, IconGauge, IconUsers, IconSettings, IconSearch, IconPlus, IconRefresh, IconCheck, IconShield, IconClose });
